import 'dart:io';
import 'package:admin/helpers/invoice/pdfHelper.dart';
...
class PdfInvoicePdfHelper {
  ...
  static Widget buildInvoiceInfo(InvoiceInfo info, Font arabicFont) {
    ...
    final data = <String>[
      info.number,
      ReusableWidgets.formatDate(info.date),
    ];
            ...
            child: Column(
              ...
              children: [
                ...
                buildText(
                  ...
                  value: ReusableWidgets.formatPrice(netTotal),
                  unite: true,
                  arabicFont: arabicFont,
                ),
                // buildText(
